...
namespace SelfpacedTask
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public string BKWaitTrialColorStr, BKGoInterfaceColorStr;
        public string CorrFeedbackBDInterfaceColorStr, ErrorFeedbackBDInterfaceColorStr;
        ...
        private void saveInputParameters()
        {
            ...
            using (StreamWriter file = new StreamWriter(file_saved))
            {
                ...
                // Save Color Settings
                file.WriteLine("\nColor Settings:");
                file.WriteLine(String.Format("{0, -40}:  {1}", "Wait Start Interface Background", BKWaitTrialColorStr));
                file.WriteLine(String.Format("{0, -40}:  {1}", "Go Interface Background", BKGoInterfaceColorStr));
                file.WriteLine(String.Format("{0, -40}:  {1}", "Correct Feedback Interface Border", CorrFeedbackBDInterfaceColorStr));
                file.WriteLine(String.Format("{0, -40}:  {1}", "Error Feedback Interface Border", ErrorFeedbackBDInterfaceColorStr));
        ...
        {/*Load Config File .json 
            ...
            */
            ...
            BKWaitTrialColorStr = configColors["Wait Start Interface Background"];
            BKGoInterfaceColorStr = configColors["Go Interface Background"];
            CorrFeedbackBDInterfaceColorStr = configColors["Correct Feedback Interface Border"];
            ErrorFeedbackBDInterfaceColorStr = configColors["Error Feedback Interface Border"];
        }
        ...
        {/*Load Config File .json 
            ...
            */
            ...
            configColors.BKGoInterfaceColorStr = BKGoInterfaceColorStr;
            configColors.CorrBDColorStr = CorrFeedbackBDInterfaceColorStr;
            configColors.ErrorBDColorStr = ErrorFeedbackBDInterfaceColorStr;
